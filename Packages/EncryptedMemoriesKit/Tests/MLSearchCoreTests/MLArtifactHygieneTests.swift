...
@Suite struct MLArtifactHygieneTests {
    ...
    @Test func noModelWeightArtifactsAreCommitted() throws {
        ...
        let scanRoots = [
            ...
            repoRoot.appendingPathComponent("Packages/EncryptedMemoriesKit/Tests"),
        ...
        for root in scanRoots {
            guard
                let enumerator = fm.enumerator(at: root, includingPropertiesForKeys: [.isRegularFileKey, .fileSizeKey])
            else { continue }
