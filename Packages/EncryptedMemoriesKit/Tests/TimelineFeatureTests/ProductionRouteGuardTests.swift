...
struct ProductionRouteGuardTests {
    ...
    @Test func nativeSDKCacheRemainsInMemoryForSafeSameProcessSignOut() throws {
        ...
        #expect(
            ...
            "SDK 0.29.1 does not dispose its SQLite repository, so sign-out must not persist that cache")
        #expect(
    ...
    @Test func sdkAlbumContentMigrationStaysParkedUntilContractIsComplete() throws {
        ...
        #expect(
            sdkManifest.contains("releases/download/0.29.1/CProtonDriveSDK.xcframework.zip"),
