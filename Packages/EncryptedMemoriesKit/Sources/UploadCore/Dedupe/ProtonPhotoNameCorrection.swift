...
/// Proton-compatible photo filename correction.
///
/// Trim whitespace, retain the last 255 characters, and delete invalid path, control, spacing,
/// and direction-mark characters. Empty or invalid results, including names that fail the 255-byte
/// or dot-name checks, use a deterministic SHA-1 placeholder with the original extension.
///
