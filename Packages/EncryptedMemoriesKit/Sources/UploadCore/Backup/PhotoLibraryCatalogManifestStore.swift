...
/// backup stores this is a cache/index, not user data: an incompatible/corrupt schema resets to empty
/// and costs only another local scan. One row per asset `localIdentifier`; resources ride in a single
/// JSON column.
