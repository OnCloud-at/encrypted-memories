...
///
/// This is a pure value. The indexing actor consumes it and turns `toIndex`
...
public struct MLIndexPlan: Sendable {
    ...
    public init(
        descriptor: MLModelDescriptor, toIndex: [PhotoUID], skippedAlreadyIndexed: [PhotoUID],
        skippedPermanentFailure: [PhotoUID]
    ) {
