...
public struct MLModelDescriptor: Hashable, Sendable, Codable {
    /// Stable, human-readable model name (e.g. `"visual-search-small"`). Must not encode a version.
    ...
    /// A short, display-safe label suitable for diagnostics (`"visual-search-small v3 (512d)"`).
