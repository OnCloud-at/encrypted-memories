    ...
    public struct UIKitTimelineGridProfileAdapter {
        ...
        public func profile(
            ...
            // UIKit surfaces are finger-driven, so use the touch profile ladder with the same level semantics.
            let viewport = TimelineGridViewport(
                layoutWidth: size.width, layoutHeight: size.height, inputAffinity: .touch)
