...
/// Bridges `AlbumCore.AlbumManaging` to `UploadCore.AlbumAttaching`, so the upload queue can do
/// "create-then-add-then-cover" without `UploadCore` ever depending on album UI. Each feature
