...
///
/// SDK 0.29.1 no longer accepts `ProtonCoreDataModel.Address`. The app maps its ProtonCore account
...
/// App-owned, fully readable projection of one ProtonCore `Address` into the SDK 0.29.1 account
