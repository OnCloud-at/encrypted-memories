...
/// boundary: SDK 0.29.1 owns catalog/sharing/membership reads, while direct Photos HTTP remains only
...
/// Direct-HTTP write seam retained only for operations absent from SDK 0.29.1.
