...
/// (point to cell). Pure routing; selection and viewer actions are injected.
@MainActor
final class MetalGridInteractionController {
    ...
    func handleClick(contentPoint: CGPoint, clickCount: Int, modifiers: GridClickModifiers) {
        ...
        selection.click(
            flatIndex: hit.flatIndex, uid: hit.uid, orderedUIDs: coordinator.orderedUIDs,
