...
/// Draws the visible grid behind the scroll view without participating in hit testing.
...
final class MetalGridDocumentSpacer: NSView {
    ...
    override func scrollWheel(with event: NSEvent) {
        if shouldBlockScroll?(event) == true { return }  // Ignore the concurrent pan during a pinch.
