...
final class MetalGridSelectionController {
    ...
    func click(
        flatIndex: Int, uid: PhotoUID, orderedUIDs: [PhotoUID], modifiers: GridClickModifiers, selectionMode: Bool
    ) {
        let decision = GridInteractionPolicy.decision(
            click: .single, modifiers: modifiers, selectionMode: selectionMode)
