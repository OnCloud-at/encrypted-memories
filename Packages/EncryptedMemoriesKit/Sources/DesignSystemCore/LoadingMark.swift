...
/// The loading mark: the single-ink Encrypted Memories logo (`EncryptedMemoriesMono`, a template vector PDF) rendered as
/// a subtle low-opacity ink, with a soft bright highlight that flows diagonally from top-left to bottom-right.
...
public struct LoadingMark: View {
    ...
    public var body: some View {
        ...
        let shaped = Image("EncryptedMemoriesMono", bundle: .module)
            .resizable()
            .scaledToFit()
