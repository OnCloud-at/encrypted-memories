...
/// Pure set-difference planning for local assets, manifest links, and current album members.
/// The result is deterministic, performs no I/O, and runs in linear time.
