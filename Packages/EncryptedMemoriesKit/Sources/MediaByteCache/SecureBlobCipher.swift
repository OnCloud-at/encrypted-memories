...
/// and bound to Associated Authenticated Data (AAD) describing its cache namespace, version, account,
/// volume, node, and derivative type.
...
public struct SecureBlobCipher: Sendable {
    /// Bump when the on-disk format or AAD construction changes; incompatible blobs fail authentication.
