...
size of an iCloud original before the download. On version 26, an original larger than 1 GB downloads a second time
for its upload. If the device does not have room for the backup copy,
