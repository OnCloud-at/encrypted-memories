...
- The official open-source Proton Drive SDK 0.27.0, distributed under the MIT License and restored at `Vendor/sdk-swift`.
...
./scripts/update-proton-sdk.sh 0.27.0
...
`VendorPatches/sdk-swift/0.27.0` after checking out the upstream tag. The updater fails before
